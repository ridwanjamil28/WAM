<section class="py-24 pt-10 bg-gray-50" id="layanan"
data-aos="fade-up">
...
<h3 class="font-bold text-lg mb-2 transition duration-300 group-hover:text-green-600">
{{ $service->nama }}
</h3>
...
<span class="text-green-600 text-2xl opacity-0 group-hover:opacity-100 transition duration-300">
→
</span>
</div>
